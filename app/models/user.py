...
class User(Base):
    ...
    oauth_provider = Column(String(50), nullable=False)  # OAuth 제공자 (google, naver, kakao)
...
class UserProfile(Base):
    ...
    __table_args__ = (
        CheckConstraint("finance_level IN ('beginner', 'intermediate', 'advanced')", name='chk_finance_level'),
    )
    ...
    interests = Column(ARRAY(String), default=list)  # 관심 분야 태그 배열 (산업, 섹터 등)
