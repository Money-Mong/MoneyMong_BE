...
from app.core.llm import generate_answer, generate_conversation_answer, generate_follow_up_questions
...
class RAGService:
    ...
    async def generate_conversation_response(
        ...
        return {
            ...
            "model_version": llm_response.get("model", "solar-pro2"), # 일반 Solar 모델로 정의
